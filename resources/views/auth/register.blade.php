            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!--bikin form untuk Alamat User-->
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('Address') }}</label>

                            <div class="col-md-6">
                                <textarea name="address" class="form-control" required autocomplete="address"></textarea>
                        ...
                        <!--bikin form untuk DOB (Date of Birthday)-->
                        ...
                        <!--bikin form role untuk masing - masing user-->
                        <div class="form-group row">
